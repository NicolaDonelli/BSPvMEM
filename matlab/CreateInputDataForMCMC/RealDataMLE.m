...
addpath('../Utilities')
load('../Data/RealData/SandSData.mat');
...
filename = strcat('../Data/RealData/Input/RealData&MLE(',Names{i_1},')_o_Bdiag_A.mat');
...
%%%% o, Bdiag, A [Model 1, Cipollini, Engle, Gallo (2013) %%%%
o_GMEM_0    = [0.01; 0.06];
B_GMEM_0    = [0.10 ;0.04];
A_GMEM_0    = [0.05 0.08
               0.02 0.02];
...
%%%%%%% o, Bdiag, A, AnegDiag, Fdiag [Model 2, Cipollini, Engle, Gallo(2013)]%%%%%%%%%%%
% o_GMEM_0    = [0.15; 0.43];
% B_GMEM_0    = [0.10; 0.41];
% A_GMEM_0    = [0.15 0.08
%               0.12 0.21];
...
%%%%%%% o, Bdiag, A, AnegDiag, F [Model 3, Cipollini, Engle, Gallo(2013)]%%%%%%%%%%%
% o_GMEM_0    = [0.15; 0.43];
% B_GMEM_0    = [0.10; 0.41];
% A_GMEM_0    = [0.15 0.08
%               0.12 0.21];
