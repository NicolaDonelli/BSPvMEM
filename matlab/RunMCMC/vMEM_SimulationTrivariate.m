...
%load RealData&MLE(SP500)_o_Bdiag_A
%load RealData&MLE(SP500)_o_Bdiag_A_Aneg_F
%load RealData&MLE(SP500)_o_Bdiag_A_AnegDiag_F
%load RealData&MLE(SP500)_o_B_A_AnegDiag_F
%load RealData&MLE(SP500)_o_B_A_AnegDiag_F_1
%load RealData&MLE(SP500)_o_B_A_AnegDiag_F_2
%load RealData&MLE(SP500)_o_B_A_AnegDiag_F_3
%load RealData&MLE(SP500)_o_Bdiag_A_AnegDiag_Fdiag_K_Gdiag_GnegDiag
%load RealData&MLE(SP500)Trivariate_o_Bdiag_A_Aneg_F
%load RealData&MLE(FTSE100)_o_Bdiag_A_AnegDiag_F
%load RealData&MLE(FTSE100)_o_Bdiag_A_AnegDiag_Fdiag_1
%load RealData&MLE(FTSE100)_o_B_A_Aneg_F
%load RealData&MLE(DJIA)_o_Bdiag_A_Aneg_F
%load RealData&MLE(DJIA)_o_Bdiag_A_AnegDiag_F_1
%%%%%%%%%%%
